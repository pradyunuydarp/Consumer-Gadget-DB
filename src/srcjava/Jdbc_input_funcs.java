...
public class Jdbc_input_funcs {
    ...
    public static void Enterprisemenu(){
      ...
      System.out.println("\t8.Enter Direct SQL Command");
   }
   ...
   public static String choicemanager_user_purchase(String idString, String gadgetidString, Integer price, Integer maxtid){

      return "insert into Ownership VALUES("+maxtid.toString()+","+idString+", "+gadgetidString+",'2024-05-04',"+" "+price.toString()+");";
   }
